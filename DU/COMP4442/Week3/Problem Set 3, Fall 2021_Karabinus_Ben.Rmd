---
title: "Problem Set 3, Fall 2021"
author: "Ben Karabinus"
output:
  word_document: default
  html_document word_document pdf_document: default
---
...
$\hat {sim \_ tot \_ fat} = 66.94 + (1)8.722 + (0)11.722 -(0)13.611$
...
A doughnut made using gluten-free flower and cooked in sunflower oil will have a predicted mean fat absorption of $\approx 47.33$ grams.
...
Question 3: The Scale-Location plot (the third plot) allows you to assess the assumption of equality of residual variance across the range of the fitted values, and we discussed three shapes that indicate potential violations of this assumption (bowtie, bullhorn, and diamond). Are any of these shapes obviously present in this plot?
